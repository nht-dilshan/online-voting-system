    ...
    <div id="confirmModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div class="mt-4 flex justify-end">
                <button id="confirmAction" class="bg-green-500 text-white px-4 py-2 rounded-md mr-2" onclick="confirmAction()">Confirm</button>
                <button class="bg-gray-400 text-white px-4 py-2 rounded-md" onclick="cancelAction()">Cancel</button>
            </div>
        </div>
    </div>
