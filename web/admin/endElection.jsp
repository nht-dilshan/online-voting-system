...
<%
    ...
    if (electionIdStr != null && !electionIdStr.isEmpty()) {
        ...
        try {
            ...
            // Update the end_date to the current date and time
            String updateQuery = "UPDATE elections SET end_date = NOW(), status = 'Ended' WHERE election_id = ?";
            ps = con.prepareStatement(updateQuery);
            ps.setInt(1, electionId);

            int rowsUpdated = ps.executeUpdate();
            if (rowsUpdated > 0) {
                out.println("Election ended successfully.");
            } else {
